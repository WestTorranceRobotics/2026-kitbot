...
public class SpinUp extends Command {
  ...
  public SpinUp(FuelSubsystemReal fuelSystem) {
  ...
  public void initialize() {
    ...
    fuelSubsystem.setFeederVoltage(SmartDashboard.getNumber("Launching spin-up feeder value", SPIN_UP_FEEDER_VOLTAGE));
  }
