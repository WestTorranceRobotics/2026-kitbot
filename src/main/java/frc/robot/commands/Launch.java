...
public class Launch extends Command {
  ...
  public Launch(FuelSubsystemReal fuelSystem) {
  ...
  public void initialize() {
    ...
    fuelSubsystem.setFeederVoltage(SmartDashboard.getNumber("Launching feeder roller value", LAUNCHING_FEEDER_VOLTAGE));
  }
